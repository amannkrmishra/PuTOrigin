...
#AutoIt3Wrapper_Outfile=Origin.exe
#AutoIt3Wrapper_Outfile_x64=Origin.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_UseUpx=y
#AutoIt3Wrapper_Res_Description=Tool created for making life easy
...
; Script name: Origin.exe
; File description: Made by Origin to make lyf easy
; File version: 1.0.0
; Product name: OriginOP
; Product version: 1.0.0
; Copyright: Copyright (C) Origin 2023
...
Func StartOrigin()
    ...
    Local $GUI_Main = GUICreate("Origin", 325, 302, -1, -1, $WS_POPUP, BitOR($WS_EX_TOPMOST, $WS_EX_WINDOWEDGE))
    ...
    Global Const $downloadUrl = 'https://raw.githubusercontent.com/amannkrmishra/Checker/main/Origin.exe'
    Global Const $filePath = @ScriptDir & '\Origin.exe'
    Global Const $tempFilePath = @ScriptDir & '\Origin_new.exe'
    Global Const $versionUrl = 'https://raw.githubusercontent.com/amannkrmishra/Checker/main/origin_version.txt'
    ...
    Else
        ...
        ; Rename the downloaded file to Origin.exe
        Run(@ScriptDir & '\change.bat', '', @SW_HIDE)

        ; Close the currently running Origin.exe process and exit the script
...
Func COMConnection()
$GUI1 = GUICreate("Origin", 225, 175, -1, -1)
